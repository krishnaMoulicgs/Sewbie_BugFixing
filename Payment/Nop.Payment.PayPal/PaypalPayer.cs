...
namespace NopSolutions.NopCommerce.Payment.Methods.PayPal
{
    ...
    public class PaypalPayer
    {
        ...
        /// <summary>
        /// Paypal payer customer value which we populate with vendorid
        /// </summary>
        public string VendorId { get; set; }
        /// <summary>
        /// Paypal payer Note which we'll put into note to seller. or Order Note 1.
        /// </summary>
        public string Note { get; set; }
        /// <summary>
        /// Paypal payer Note which we'll put into note to seller. or Order Note 1.
        /// </summary>
        public string PaypalVendorAccount { get; set; }

        /// <summary>
        /// CustomerId to be returned to prevent errors at the return page.
        /// </summary>
