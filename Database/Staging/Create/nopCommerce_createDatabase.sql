...
CREATE TABLE [dbo].[Nop_ProductVariant](
	...
	[CreatedOn] [datetime] NOT NULL,
	[UpdatedOn] [datetime] NOT NULL,
	[VendorID] [int] NOT NULL CONSTRAINT [DF_Nop_ProductVariant_VendorID] DEFAULT((37)),
...
ALTER TABLE [dbo].[Vendor]  WITH NOCHECK ADD  CONSTRAINT [FK_Vendor_Nop_Customer] FOREIGN KEY([CustomerId])
REFERENCES [dbo].[Nop_Customer] ([CustomerID])
GO

ALTER TABLE [dbo].[Vendor] CHECK CONSTRAINT [FK_Vendor_Nop_Customer]
GO

ALTER TABLE [dbo].[Vendor] ADD  CONSTRAINT [DF_Vendor_CustomerId]  DEFAULT ((37)) FOR [CustomerId]
GO

ALTER TABLE [dbo].[Vendor] ADD  CONSTRAINT [DF_Vendor_CompanyName]  DEFAULT ('') FOR [CompanyName]
GO

ALTER TABLE [dbo].[Vendor] ADD  CONSTRAINT [DF_Vendor_PayalEmailAddress]  DEFAULT ('') FOR [PaypalEmailAddress]
GO
