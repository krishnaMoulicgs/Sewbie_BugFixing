...
namespace NopSolutions.NopCommerce.Web
{
    public partial class CheckoutPage : BaseNopFrontendPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/VendorCheckout.aspx");
                //Response.Redirect("~/checkoutonepage.aspx");

            }
            else
            {
                //this osShop page is not actually a one page checkout page.  it only works if
                //useonepagecheckout is false.
                //Response.Redirect("~/AddonsByOsShop/UserExperience/AjaxOnePageCheckout/CheckOutOnePage.aspx");
