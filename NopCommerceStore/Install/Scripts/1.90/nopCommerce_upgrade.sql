...
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13128, 7, N'OsShop.Osshop', N'OsShop')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13129, 7, N'OsShop.menuprofessional', N'Menu Professional')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13130, 7, N'OsShop.menuelite', N'Menu Elite')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13131, 7, N'OsShop.Whatnew', N'What is new')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13132, 7, N'OsShop.allbrands', N'All Brands')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13133, 7, N'OsShop.searchtips', N'Most Relevant Matches Shown. Click Search For More Items')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13134, 7, N'OsShop.shopbyproduct', N'Shop by product')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13135, 7, N'OsShop.brands', N'Shop by Brand')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13136, 7, N'OsShop.getinspired', N'Get inspired')
INSERT [dbo].[Nop_LocaleStringResource] ([LocaleStringResourceID], [LanguageID], [ResourceName], [ResourceValue]) VALUES (13137, 7, N'OsShop.quicklook', N'Quick look')
