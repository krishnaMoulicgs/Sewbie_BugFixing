...
<script type="text/javascript">
    ...
    function dealRegister(email) {
        ...
        jQuery.ajax({
            url: "/AddonsByOsShop/AjaxPages/dealRegisterLogin.aspx?" + new Date().getTime(), //加入时间 url欺骗 重新运行ajax
            type: "Get",
            data: 'emailAddress=' + email,
            success: function (data, statue) {
                dataEmail = data + "";
                var strItem = new Array();
                strItem = dataEmail.split("<!>"); //每个商品之间用 <!> 分割
            ...
            <WizardSteps> 
                ...
                <asp:CompleteWizardStep ID="CompleteWizardStep1" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="section-body">
                            <asp:Button ID="RegisterVendor" runat="server" OnClick="RegisterVendor_Click" CssClass="completeregistrationbutton"
                                Text="Register As Seller" ValidationGroup="CreateUserForm" />
                        </div>
                        <div class="clear">
                        </div>
                    </ContentTemplate>
