...
<div class="login-page">
    ...
    <div class="wrapper">
        ...
        <%}
          ...
          <div class="new-wrapper">
            <span class="register-title">
                <%=GetLocaleResourceString("Checkout.CheckoutAsGuest")%></span>
            <div class="checkout-as-guest-or-register-block">
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <%=GetLocaleResourceString("Checkout.CheckoutAsGuestWelcomeHeader") %>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <%=GetLocaleResourceString("Checkout.CheckoutAsGuestEmailLabel") %>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="text" runat="server" id="txtGuestEmail" class="textBox"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="padding-right: 20px; padding-top: 20px;">
                                <input type="hidden" runat="server" id="hdnBadEmail" value="" />
                                <span id="txtEmailError" runat="server" style="color:Red;"></span>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="new-wrapper">
            <span class="register-title">
                <%=GetLocaleResourceString("Checkout.Register")%></span>
            <div class="checkout-as-guest-or-register-block">
                <table>
                    <tbody>
                        <tr>
