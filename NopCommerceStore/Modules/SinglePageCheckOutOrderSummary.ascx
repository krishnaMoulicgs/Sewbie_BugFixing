<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SinglePageCheckOutOrderSummary.ascx.cs" Inherits="NopSolutions.NopCommerce.Web.Modules.SinglePageCheckOutOrderSummary" %>
                        ...
                        <ItemTemplate>
                            <tr class="cart-item-row">
                                ...
                                <td style="white-space: nowrap;">
                                    <%if (IsShoppingCart)
                                        { %>
                                    <asp:TextBox ID="txtQuantity" size="4" runat="server" Text='<%# ((ShoppingCartItem)Container.DataItem).Quantity %>'
