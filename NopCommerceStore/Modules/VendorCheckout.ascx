<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Modules.VendorCheckoutControl"
    CodeBehind="VendorCheckout.ascx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register TagPrefix="nopCommerce" TagName="CheckoutShippingAddress" Src="~/Modules/CheckoutShippingAddress.ascx" %>
<%@ Register TagPrefix="nopCommerce" TagName="CheckoutBillingAddress" Src="~/Modules/VendorCheckoutBillingAddress.ascx" %>
...
<%@ Register TagPrefix="nopCommerce" TagName="VendorOrderSummary" Src="~/Modules/VendorOrderSummary.ascx" %>
    ...
    <div class="checkout-data">
        ...
        <asp:UpdatePanel ID="upCheckout" runat="server">
            <ContentTemplate>
                ...
                <!-- PaymentMethods -->
                <div runat="server" id="pnlPaymentMethods" class="checkoutstep" style="display:none;">
                    <div class="steptitle">
                ...
                <!-- PaymentInfo -->
                <div runat="server" id="pnlPaymentInfo" class="checkoutstep" style="display:none;">
                    <div class="steptitle">
                ...
                <div runat="server" id="pnlConfirm" class="checkoutstep">
                    ...
                    <asp:Panel runat="server" ID="pnlConfirmContent" class="stepcontent">
                        ...
                        <div class="order-summary-body">
                            <nopCommerce:VendorOrderSummary ID="OrderSummaryControl" runat="server" IsShoppingCart="false" />
                        </div>
