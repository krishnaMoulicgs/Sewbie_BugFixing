<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Modules.VendorCheckoutBillingAddressControl"
    CodeBehind="VendorCheckoutBillingAddress.ascx.cs" %>
