<%@ Page Language="C#" MasterPageFile="~/VendorAdministration/main.master" AutoEventWireup="true"
    Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Administration_Default"
...
<asp:Content ID="c1" ContentPlaceHolderID="cph1" runat="Server">
    <div class="section-title">
        <img src="Common/ico-dashboard.png" alt="<%=GetLocaleResourceString("VendorAdmin.Dashboard")%>" />
        <%=GetLocaleResourceString("VendorAdmin.Dashboard")%>
    </div>
        ...
        <tr>
            <td class="maincol">
                <div class="section-header">
                    <div class="title">
                        <img src="Common/ico-stat1.gif" alt="<%=GetLocaleResourceString("VendorAdmin.StoreStatistics")%>" />
                         <%=GetLocaleResourceString("VendorAdmin.StoreStatistics")%>
                    </div>
                </div>
