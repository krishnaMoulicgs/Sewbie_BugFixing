<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.ProductsControl" CodeBehind="Products.ascx.cs" %>
...
<div class="section-header">
    ...
    <div class="options">
        ...
        <input type="button" onclick="location.href='ProductDetails.aspx'" value="<%=GetLocaleResourceString("Admin.Products.AddButton.Text")%>"
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblProductName" Text="<% $NopResources:Admin.Products.ProductName %>"
                ToolTip="<% $NopResources:Admin.Products.ProductName.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategory" Text="<% $NopResources:Admin.Products.Category %>"
                ToolTip="<% $NopResources:Admin.Products.Category.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <%--<nopCommerce:ToolTipLabel runat="server" ID="lblManufacturer" Text="<% $NopResources:Admin.Products.Manufacturer %>"
                ToolTip="<% $NopResources:Admin.Products.Manufacturer.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />--%>
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <%--<nopCommerce:ToolTipLabel runat="server" ID="lblGoDirectlyToSKU" Text="<% $NopResources:Admin.Products.GoDirectlySKU %>"
                ToolTip="<% $NopResources:Admin.Products.GoDirectlySKU.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />--%>
        </td>
        <td class="adminData">
