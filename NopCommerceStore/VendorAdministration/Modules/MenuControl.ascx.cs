...
{
    public partial class MenuControl : BaseNopVendorAdministrationUserControl
    {
        #region Handlers
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                ...
                else
                {
                    ...
                    //sb.Append("<li><a class='osshop_adminMenu' href='" + CommonHelper.GetStoreLocation() + "Administration/OsShopAdmin/functionMenu.aspx'" + "><img style='width:16px; height:16px; float:left;' src='/App_Themes/administration/images/osshop.png'></img>  " + GetLocaleResourceString("OsShop.OsShop") + "</a></li>");
                    //sb.Append("</ul>");
