<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.LogsControl"
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCreatedOnFrom" Text="<% $NopResources:Admin.Log.CreatedOnFrom %>"
                ToolTip="<% $NopResources:Admin.Log.CreatedOnFrom.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCreatedOnTo" Text="<% $NopResources:Admin.Log.CreatedOnTo %>"
                ToolTip="<% $NopResources:Admin.Log.CreatedOnTo.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblMessage" Text="<% $NopResources:Admin.Log.Message %>"
                ToolTip="<% $NopResources:Admin.Log.Message.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblLogType" Text="<% $NopResources:Admin.Log.LogType %>"
                ToolTip="<% $NopResources:Admin.Log.LogType.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
