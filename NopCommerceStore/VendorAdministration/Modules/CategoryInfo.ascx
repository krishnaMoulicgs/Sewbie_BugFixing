<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.CategoryInfoControl"
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryName" Text="<% $NopResources:Admin.CategoryInfo.Name %>"
                        ToolTip="<% $NopResources:Admin.CategoryInfo.Name.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryDescription" Text="<% $NopResources:Admin.CategoryInfo.Description %>"
                        ToolTip="<% $NopResources:Admin.CategoryInfo.Description.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryImage" Text="<% $NopResources:Admin.CategoryInfo.Image %>"
                ToolTip="<% $NopResources:Admin.CategoryInfo.Image.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryTemplate" Text="<% $NopResources:Admin.CategoryInfo.CategoryTemplate %>"
                ToolTip="<% $NopResources: Admin.CategoryInfo.CategoryTemplate.Tooltip%>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblParentCategory" Text="<% $NopResources:Admin.CategoryInfo.ParentCategory %>"
                ToolTip="<% $NopResources:Admin.CategoryInfo.ParentCategory.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryPriceRanges" Text="<% $NopResources: Admin.CategoryInfo.PriceRanges%>"
                ToolTip="<% $NopResources: Admin.CategoryInfo.PriceRanges.Tooltip%>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryShowOnHomePage" Text="<% $NopResources:Admin.CategoryInfo.ShowOnHomePage %>"
                ToolTip="<% $NopResources:Admin.CategoryInfo.ShowOnHomePage.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryPublished" Text="<% $NopResources:Admin.CategoryInfo.Published %>"
                ToolTip="<% $NopResources:Admin.CategoryInfo.Published.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryDisplayOrder" Text="<% $NopResources:Admin.CategoryInfo.DisplayOrder %>"
                ToolTip="<% $NopResources:Admin.CategoryInfo.DisplayOrder.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
