<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.ProductSEOControl"
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblProductMetaKeywords" Text="<% $NopResources:Admin.ProductSEO.MetaKeywords %>"
                        ToolTip="<% $NopResources:Admin.ProductSEO.MetaKeywords.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblProductMetaDescription" Text="<% $NopResources:Admin.ProductSEO.MetaDescription %>"
                        ToolTip="<% $NopResources:Admin.ProductSEO.MetaDescription.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblProductMetaTitle" Text="<% $NopResources:Admin.ProductSEO.MetaTitle %>"
                        ToolTip="<% $NopResources:Admin.ProductSEO.MetaTitle.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblProductSEName" Text="<% $NopResources:Admin.ProductSEO.SEName %>"
                        ToolTip="<% $NopResources:Admin.ProductSEO.SEName.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
