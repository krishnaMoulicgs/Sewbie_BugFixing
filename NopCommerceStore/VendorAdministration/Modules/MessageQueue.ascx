<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.MessageQueueControl" CodeBehind="MessageQueue.ascx.cs" %>
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblStartDate" Text="<% $NopResources:Admin.MessageQueue.StartDate %>"
                ToolTip="<% $NopResources:Admin.MessageQueue.StartDate.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblEndDate" Text="<% $NopResources:Admin.MessageQueue.EndDate %>"
                ToolTip="<% $NopResources:Admin.MessageQueue.EndDate.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblFromEmail" Text="<% $NopResources:Admin.MessageQueue.From %>"
                ToolTip="<% $NopResources:Admin.MessageQueue.From.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblToEmail" Text="<% $NopResources:Admin.MessageQueue.ToEmail %>"
                ToolTip="<% $NopResources:Admin.MessageQueue.ToEmail.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblLoadNotSentItemsOnly" Text="<% $NopResources:Admin.MessageQueue.LoadNotSent %>"
                ToolTip="<% $NopResources:Admin.MessageQueue.LoadNotSent.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblMaxSendTries" Text="<% $NopResources:Admin.MessageQueue.MaxSendTries %>"
                ToolTip="<% $NopResources:Admin.MessageQueue.MaxSendTries.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblGoDirectlyToEmailNumber" Text="<% $NopResources:Admin.MessageQueue.GoDirectly %>"
                ToolTip="<% $NopResources:Admin.MessageQueue.GoDirectly.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
