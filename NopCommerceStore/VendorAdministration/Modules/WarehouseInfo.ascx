<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.WarehouseInfoControl"
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblName" Text="<% $NopResources:Admin.WarehouseInfo.Name %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Name.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblPhoneNumber" Text="<% $NopResources:Admin.WarehouseInfo.Phone %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Phone.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblEmail" Text="<% $NopResources:Admin.WarehouseInfo.Email %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Email.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblFaxNumber" Text="<% $NopResources:Admin.WarehouseInfo.Fax %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Fax.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblAddress1" Text="<% $NopResources:Admin.WarehouseInfo.Address1 %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Address1.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblAddress2" Text="<% $NopResources:Admin.WarehouseInfo.Address2 %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Address2.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCity" Text="<% $NopResources:Admin.WarehouseInfo.City %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.City.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblStateProvince" Text="<% $NopResources:Admin.WarehouseInfo.State %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.State.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblZipPostalCode" Text="<% $NopResources:Admin.WarehouseInfo.Zip %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Zip.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCountry" Text="<% $NopResources:Admin.WarehouseInfo.Country %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.Country.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr runat="server" id="pnlCreatedOn">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCreatedOnTitle" Text="<% $NopResources:Admin.WarehouseInfo.CreatedOn %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.CreatedOn.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr runat="server" id="pnlUpdatedOn">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblUpdatedOnTitle" Text="<% $NopResources:Admin.WarehouseInfo.UpdatedOn %>"
                ToolTip="<% $NopResources:Admin.WarehouseInfo.UpdatedOn.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
