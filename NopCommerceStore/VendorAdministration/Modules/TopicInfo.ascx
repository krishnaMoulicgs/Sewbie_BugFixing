<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.TopicInfoControl"
                ...
                <tr>
                    <td class="adminTitle">
                        <nopCommerce:ToolTipLabel runat="server" ID="lblSystemName" Text="<% $NopResources:Admin.TopicInfo.SystemName %>"
                            ToolTip="<% $NopResources:Admin.TopicInfo.SystemName.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                    </td>
                    <td class="adminData">
                ...
                <tr>
                    <td class="adminTitle">
                        <nopCommerce:ToolTipLabel runat="server" ID="lblIsPasswordProtected" Text="<% $NopResources:Admin.TopicInfo.IsPasswordProtected %>"
                            ToolTip="<% $NopResources:Admin.TopicInfo.IsPasswordProtected.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                    </td>
                    <td class="adminData">
                ...
                <tr id="pnlPassword">
                    <td class="adminTitle">
                        <nopCommerce:ToolTipLabel runat="server" ID="lblPassword" Text="<% $NopResources:Admin.TopicInfo.Password %>"
                            ToolTip="<% $NopResources:Admin.TopicInfo.Password.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                    </td>
                    <td class="adminData">
                ...
                <tr>
                    <td class="adminTitle">
                        <nopCommerce:ToolTipLabel runat="server" ID="lblIncludeInSitemap" Text="<% $NopResources:Admin.TopicInfo.IncludeInSitemap %>"
                            ToolTip="<% $NopResources:Admin.TopicInfo.IncludeInSitemap.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                    </td>
                    <td class="adminData">
                                ...
                                <tr>
                                    <td class="adminTitle">
                                        <nopCommerce:ToolTipLabel runat="server" ID="lblBody" Text="<% $NopResources:Admin.TopicLocalizedDetails.Body %>"
                                            ToolTip="<% $NopResources:Admin.TopicLocalizedDetails.Body.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                                    </td>
                                    <td class="adminData">
                                ...
                                <tr runat="server" id="pnlUrl">
                                    <td class="adminTitle">
                                        <nopCommerce:ToolTipLabel runat="server" ID="lblUrlTooltip" Text="<% $NopResources:Admin.TopicInfo.Url %>"
                                            ToolTip="<% $NopResources:Admin.TopicInfo.Url.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                                    </td>
                                    <td class="adminData">
                                ...
                                <tr>
                                    <td class="adminTitle">
                                        <nopCommerce:ToolTipLabel runat="server" ID="lblTopicMetaTitle" Text="<% $NopResources:Admin.TopicLocalizedDetails.MetaTitle %>"
                                            ToolTip="<% $NopResources:Admin.TopicLocalizedDetails.MetaTitle.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                                    </td>
                                    <td class="adminData">
