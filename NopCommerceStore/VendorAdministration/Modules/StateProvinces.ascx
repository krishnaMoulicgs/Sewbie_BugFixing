<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.StateProvincesControl"
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblSelectCountry" Text="<% $NopResources:Admin.StateProvinces.SelectCountry %>"
                ToolTip="<% $NopResources:Admin.StateProvinces.SelectCountry.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
