<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.nopCommerceNewsControl"
...
<div class="nop-news">
    <div class="section-header">
        <div class="title">
            <img src="Common/ico-news.gif" alt="<%=GetLocaleResourceString("VendorAdmin.News")%>" />
            <%=GetLocaleResourceString("VendorAdmin.News")%>
        </div>
    </div>
