...
// The Initial Developer of thVendorAdministratione Original Code is NopSolutions.
// All Rights Reserved.
// 
...
{
    public partial class OrderStatisticsControl : BaseNopVendorAdministrationUserControl
    {
        ...
        {
            //pending
            var orders_os_pending = this.OrderService.GetVendorOrderReport(OrderStatusEnum.Pending, null, null);
            ...
            //not paid
            var orders_ps_pending = this.OrderService.GetVendorOrderReport(null, PaymentStatusEnum.Pending, null);
            ...
            //not shipped
            var orders_ss_pending = this.OrderService.GetVendorOrderReport(null, null, ShippingStatusEnum.NotYetShipped);
