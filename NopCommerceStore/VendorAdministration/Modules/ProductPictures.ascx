<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.ProductPicturesControl"
    ...
    <asp:GridView ID="gvwImages" runat="server" AutoGenerateColumns="false" DataKeyNames="ProductPictureId"
        ...
        <Columns>
            <asp:TemplateField HeaderText="<% $NopResources:Admin.ProductPictures.Image %>" ItemStyle-Width="50%">
                <ItemTemplate>
                    <asp:Image ID="iProductPicture" runat="server" AlternateText="pic" Height="80px" Width="80px" />
        ...
        <tr>
            <td class="adminTitle">
                <nopCommerce:ToolTipLabel runat="server" ID="lblSelectPicture1" Text="<% $NopResources:Admin.ProductPictures.SelectPicture %>"
                    ToolTip="<% $NopResources:Admin.ProductPictures.SelectPicture.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
            </td>
            <td class="adminData">
