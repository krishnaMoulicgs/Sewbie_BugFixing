<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.MessageTemplateDetailsControl"
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblName" text="<% $NopResources:Admin.MessageTemplateDetails.Name %>"
                tooltip="<% $NopResources:Admin.MessageTemplateDetails.Name.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
                    ...
                    <tr>
                        <td class="adminTitle">
                            <nopcommerce:tooltiplabel runat="server" id="lblEmailAccount" text="<% $NopResources:Admin.MessageTemplateDetails.EmailAccount %>"
                                tooltip="<% $NopResources:Admin.MessageTemplateDetails.EmailAccount.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                        </td>
                        <td class="adminData">
                    ...
                    <tr>
                        <td class="adminTitle">
                            <nopcommerce:tooltiplabel runat="server" id="lblSubject" text="<% $NopResources:Admin.MessageTemplateDetails.Subject %>"
                                tooltip="<% $NopResources:Admin.MessageTemplateDetails.Subject.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                        </td>
                        <td class="adminData">
                    ...
                    <tr>
                        <td class="adminTitle">
                            <nopcommerce:tooltiplabel runat="server" id="lblBody" text="<% $NopResources:Admin.MessageTemplateDetails.Body %>"
                                tooltip="<% $NopResources:Admin.MessageTemplateDetails.Body.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                        </td>
                        <td class="adminData">
                    ...
                    <tr>
                        <td class="adminTitle">
                            <nopcommerce:tooltiplabel runat="server" id="lblActive" text="<% $NopResources:Admin.MessageTemplateDetails.Active %>"
                                tooltip="<% $NopResources:Admin.MessageTemplateDetails.Active.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                        </td>
                        <td class="adminData">
