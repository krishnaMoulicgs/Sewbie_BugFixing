<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.CheckoutAttributeInfoControl"
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblName" Text="<% $NopResources:Admin.CheckoutAttributeInfo.Name.Text %>"
                        ToolTip="<% $NopResources:Admin.CheckoutAttributeInfo.Name.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblTaxExempt" Text="<% $NopResources:Admin.CheckoutAttributeInfo.TaxExempt %>"
                ToolTip="<% $NopResources:Admin.CheckoutAttributeInfo.TaxExempt.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblTaxCategory" Text="<% $NopResources:Admin.CheckoutAttributeInfo.TaxCategory %>"
                ToolTip="<% $NopResources:Admin.CheckoutAttributeInfo.TaxCategory.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
