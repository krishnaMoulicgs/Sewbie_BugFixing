<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.ProductVariantInfoControl"
    ...
    <tr runat="server" id="pnlProductVariantId">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblCreatedOnTitle" text="<% $NopResources:Admin.ProductVariantInfo.ID %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.ID.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopcommerce:tooltiplabel runat="server" id="lblDescription" text="<% $NopResources:Admin.ProductVariantInfo.Description %>"
                        tooltip="<% $NopResources:Admin.ProductVariantInfo.Description.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblSKU" text="<% $NopResources:Admin.ProductVariantInfo.SKU %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.SKU.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblImage" text="<% $NopResources:Admin.ProductVariantInfo.Image %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.Image.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblAdminComment" text="<% $NopResources:Admin.ProductVariantInfo.AdminComment %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.AdminComment.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblPrice" text="<% $NopResources:Admin.ProductVariantInfo.Price %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.Price.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblOldPrice" text="<% $NopResources:Admin.ProductVariantInfo.OldPrice %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.OldPrice.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblProductCost" text="<% $NopResources:Admin.ProductVariantInfo.ProductCost %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.ProductCost.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblCallForPrice" text="<% $NopResources:Admin.ProductVariantInfo.CallForPrice %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.CallForPrice.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblIsGiftCard" text="<% $NopResources:Admin.ProductVariantInfo.IsGiftCard %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.IsGiftCard.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlGiftCardType">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblGiftCardType" text="<% $NopResources:Admin.ProductVariantInfo.GiftCardType %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.GiftCardType.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblIsDownload" text="<% $NopResources:Admin.ProductVariantInfo.IsDownload %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.IsDownload.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlDownloadURL">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblDownloadURL" text="<% $NopResources:Admin.ProductVariantInfo.DownloadURL %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.DownloadURL.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlDownloadFile">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblDownloadFile" text="<% $NopResources:Admin.ProductVariantInfo.DownloadFile %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.DownloadFile.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblIsRecurring" text="<% $NopResources:Admin.ProductVariantInfo.IsRecurring %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.IsRecurring.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlCycleLength">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblCycleLength" text="<% $NopResources: Admin.ProductVariantInfo.CycleLength %>"
                tooltip="<% $NopResources: Admin.ProductVariantInfo.CycleLength.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlCyclePeriod">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblCyclePeriod" text="<% $NopResources:Admin.ProductVariantInfo.CyclePeriod %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.CyclePeriod.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlTotalCycles">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblTotalCycles" text="<% $NopResources: Admin.ProductVariantInfo.TotalCycles %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.TotalCycles.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblShipEnabled" text="<% $NopResources:Admin.ProductVariantInfo.ShipEnabled %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.ShipEnabled.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlFreeShipping">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblFreeShipping" text="<% $NopResources:Admin.ProductVariantInfo.FreeShipping %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.FreeShipping.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlWeight">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblWeight" Text="<% $NopResources:Admin.ProductVariantInfo.Weight %>"
                ToolTip="<% $NopResources:Admin.ProductVariantInfo.Weight.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlLength">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblLength" Text="<% $NopResources:Admin.ProductVariantInfo.Length %>"
                ToolTip="<% $NopResources:Admin.ProductVariantInfo.Length.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlWidth">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblWidth" Text="<% $NopResources:Admin.ProductVariantInfo.Width %>"
                ToolTip="<% $NopResources:Admin.ProductVariantInfo.Width.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlHeight">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblHeight" Text="<% $NopResources: Admin.ProductVariantInfo.Height%>"
                ToolTip="<% $NopResources:Admin.ProductVariantInfo.Height.ToolTip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblTaxExempt" text="<% $NopResources:Admin.ProductVariantInfo.TaxExempt %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.TaxExempt.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblTaxCategory" text="<% $NopResources:Admin.ProductVariantInfo.TaxCategory %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.TaxCategory.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblManageStock" text="<% $NopResources:Admin.ProductVariantInfo.ManageStock %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.ManageStock.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr id="pnlBackorders">
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblBackorders" text="<% $NopResources:Admin.ProductVariantInfo.Backorders %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.Backorders.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblWarehouse" text="<% $NopResources:Admin.ProductVariantInfo.Warehouse %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.Warehouse.Tooltip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblProductPublished" text="<% $NopResources:Admin.ProductVariantInfo.Published %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.Published.ToolTip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblDisplayOrder" text="<% $NopResources:Admin.ProductVariantInfo.DisplayOrder %>"
                tooltip="<% $NopResources:Admin.ProductVariantInfo.DisplayOrder.ToolTip %>" tooltipimage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
