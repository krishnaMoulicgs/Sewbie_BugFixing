<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.LogDetailsControl"
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblLogTypeTitle" Text="<% $NopResources:Admin.LogDetails.LogType %>"
                ToolTip="<% $NopResources:Admin.LogDetails.LogType.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblSeverityTitle" Text="<% $NopResources:Admin.LogDetails.Severity %>"
                ToolTip="<% $NopResources:Admin.LogDetails.Severity.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblMessageTitle" Text="<% $NopResources:Admin.LogDetails.Message %>"
                ToolTip="<% $NopResources:Admin.LogDetails.Message.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblExceptionTitle" Text="<% $NopResources:Admin.LogDetails.Exception %>"
                ToolTip="<% $NopResources:Admin.LogDetails.Exception.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblIPAddressTitle" Text="<% $NopResources:Admin.LogDetails.IPAddress %>"
                ToolTip="<% $NopResources:Admin.LogDetails.IPAddress.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCustomerTitle" Text="<% $NopResources:Admin.LogDetails.Customer %>"
                ToolTip="<% $NopResources:Admin.LogDetails.Customer.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblPageURLTitle" Text="<% $NopResources:Admin.LogDetails.PageURL %>"
                ToolTip="<% $NopResources:Admin.LogDetails.PageURL.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblReferrerURLTitle" Text="<% $NopResources:Admin.LogDetails.ReferrerURL %>"
                ToolTip="<% $NopResources:Admin.LogDetails.ReferrerURL.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCreatedOnTitle" Text="<% $NopResources:Admin.LogDetails.CreatedOn %>"
                ToolTip="<% $NopResources:Admin.LogDetails.CreatedOn.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
