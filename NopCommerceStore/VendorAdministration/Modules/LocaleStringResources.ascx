<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.LocaleStringResourcesControl"
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblLanguage" Text="<% $NopResources:Admin.LocaleStringResources.Language %>"
                ToolTip="<% $NopResources:Admin.LocaleStringResources.Language.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblResourceName" Text="<% $NopResources:Admin.LocaleStringResources.ResourceName %>"
                ToolTip="<% $NopResources:Admin.LocaleStringResources.ResourceName.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblResourceValue" Text="<% $NopResources:Admin.LocaleStringResources.ResourceValue %>"
                ToolTip="<% $NopResources:Admin.LocaleStringResources.ResourceValue.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
