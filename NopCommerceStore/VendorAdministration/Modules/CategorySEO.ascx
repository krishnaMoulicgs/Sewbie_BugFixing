<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.CategorySEOControl"
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblMetaKeywords" Text="<% $NopResources:Admin.CategorySEO.MetaKeywords %>"
                        ToolTip="<% $NopResources:Admin.CategorySEO.MetaKeywords.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblMetaDescription" Text="<% $NopResources:Admin.CategorySEO.MetaDescription %>"
                        ToolTip="<% $NopResources:Admin.CategorySEO.MetaDescription.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblMetaTitle" Text="<% $NopResources:Admin.CategorySEO.MetaTitle %>"
                        ToolTip="<% $NopResources:Admin.CategorySEO.MetaTitle.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
            ...
            <tr>
                <td class="adminTitle">
                    <nopCommerce:ToolTipLabel runat="server" ID="lblSEName" Text="<% $NopResources:Admin.CategorySEO.SEName %>"
                        ToolTip="<% $NopResources:Admin.CategorySEO.SEName.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
                </td>
                <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCategoryPageSize" Text="<% $NopResources:Admin.CategorySEO.PageSize %>"
                ToolTip="<% $NopResources:Admin.CategorySEO.PageSize.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
