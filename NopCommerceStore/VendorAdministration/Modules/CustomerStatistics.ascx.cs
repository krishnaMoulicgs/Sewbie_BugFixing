...
{
    public partial class CustomerStatisticsControl : BaseNopVendorAdministrationUserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lnkViewCustomers.NavigateUrl = "~/VendorAdministration/Customers.aspx?ShowDays=" + days;
        }
