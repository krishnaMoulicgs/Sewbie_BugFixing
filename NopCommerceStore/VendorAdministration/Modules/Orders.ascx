<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.OrdersControl" CodeBehind="Orders.ascx.cs" %>
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblStartDate" Text="<% $NopResources:Admin.Orders.StartDate %>"
                ToolTip="<% $NopResources:Admin.Orders.StartDate.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblEndDate" Text="<% $NopResources:Admin.Orders.EndDate %>"
                ToolTip="<% $NopResources:Admin.Orders.EndDate.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCustomerEmail" Text="<% $NopResources:Admin.Orders.CustomerEmail %>"
                ToolTip="<% $NopResources:Admin.Orders.CustomerEmail.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblOrderStatus" Text="<% $NopResources:Admin.Orders.OrderStatus %>"
                ToolTip="<% $NopResources:Admin.Orders.OrderStatus.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblPaymentStatus" Text="<% $NopResources:Admin.Orders.PaymentStatus %>"
                ToolTip="<% $NopResources:Admin.Orders.PaymentStatus.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblShippingStatus" Text="<% $NopResources:Admin.Orders.ShippingStatus %>"
                ToolTip="<% $NopResources:Admin.Orders.ShippingStatus.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblOrderGuid" Text="<% $NopResources:Admin.Orders.OrderGuid %>"
                ToolTip="<% $NopResources:Admin.Orders.OrderGuid.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
