<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.ThirdPartyIntegrationControl"
            ...
            <ContentTemplate>
                <table class="adminContent">
                    ...
                    <tr id="pnlQuickBooksUsername">
                        <td class="adminTitle">
                            <nopCommerce:ToolTipLabel runat="server" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>"
