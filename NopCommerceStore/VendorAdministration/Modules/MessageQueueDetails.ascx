<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.VendorAdministration.Modules.MessageQueueDetailsControl"
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblPriority" Text="<% $NopResources:Admin.MessageQueueDetails.Priority %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.Priority.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblFrom" Text="<% $NopResources:Admin.MessageQueueDetails.From %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.From.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblFromName" Text="<% $NopResources:Admin.MessageQueueDetails.FromName %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.FromName.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblTo" Text="<% $NopResources:Admin.MessageQueueDetails.To %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.To.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblToName" Text="<% $NopResources:Admin.MessageQueueDetails.ToName %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.ToName.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCC" Text="<% $NopResources:Admin.MessageQueueDetails.CC %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.CC.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblBcc" Text="<% $NopResources:Admin.MessageQueueDetails.Bcc %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.Bcc.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblSubject" Text="<% $NopResources:Admin.MessageQueueDetails.Subject %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.Subject.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblBody" Text="<% $NopResources:Admin.MessageQueueDetails.Body %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.Body.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblCreatedOnTitle" Text="<% $NopResources:Admin.MessageQueueDetails.CreatedOn %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.CreatedOn.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblSendTries" Text="<% $NopResources:Admin.MessageQueueDetails.SendTries %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.SendTries.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblSendOnTitle" Text="<% $NopResources:Admin.MessageQueueDetails.SendOn %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.SendOn.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblEmailAccountTitle" Text="<% $NopResources:Admin.MessageQueueDetails.EmailAccount %>"
                ToolTip="<% $NopResources:Admin.MessageQueueDetails.EmailAccount.Tooltip %>" ToolTipImage="<% $NopResources:VendorAdmin.HelpIcon.Path %>" />
        </td>
        <td class="adminData">
