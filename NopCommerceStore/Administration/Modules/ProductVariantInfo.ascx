...
<table class="adminContent">
    ...
    <tr id="pnlCycleLength">
        ...
        <td class="adminData">
            <%--Removing the validation here, since we do not use it and it forces the values to be populated for validation.--%>
            <nopcommerce:numerictextbox runat="server" cssclass="adminInput" id="txtCycleLength"
                minimumvalue="1" maximumvalue="999999" value="100">
            </nopcommerce:numerictextbox>
        </td>
    </tr>
    ...
    <tr id="pnlTotalCycles">
        ...
        <td class="adminData">
            <nopcommerce:numerictextbox runat="server" cssclass="adminInput" id="txtTotalCycles"
                minimumvalue="1" maximumvalue="999999" value="10">
            </nopcommerce:numerictextbox>
        </td>
    </tr>
    <tr class="adminSeparator">
