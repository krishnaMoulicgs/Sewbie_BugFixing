...
<table class="adminContent">
    ...
    <tr id="pnlVendor">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblVendor" Text="<% $NopResources:Admin.ProductInfo.Vendor %>"
                ToolTip="<% $NopResources:Admin.ProductInfo.Vendor.Tooltip %>" ToolTipImage="~/Administration/Common/ico-help.gif" />
        </td>
        <td class="adminData">
