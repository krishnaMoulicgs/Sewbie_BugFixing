<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Rfilter.ascx.cs" Inherits="NopSolutions.NopCommerce.Web.AddonsByOsShop.Modules.Rfilter" %>
...
<script src="/AddonsByOsShop/CustomScripts/RajaxClient.js" type="text/javascript"></script>
