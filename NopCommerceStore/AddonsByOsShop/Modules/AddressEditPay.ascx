<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddressEditPay.ascx.cs" Inherits="NopSolutions.NopCommerce.Web.OnePagePay.AddressEditPay" %>
...
<table>
<tr><td colspan="2"><%=StarMark%></td></tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:TextBox ID="txtStateProvince" runat="server" style="display:none;"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
