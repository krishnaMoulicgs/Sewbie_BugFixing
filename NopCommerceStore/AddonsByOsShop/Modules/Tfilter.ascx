<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tfilter.ascx.cs" Inherits="NopSolutions.NopCommerce.Web.AddonsByOsShop.Modules.Tfilter" %>

<%--<script src="/Scripts/jquery-1.3.2.js" type="text/javascript"></script>--%>
<script src="/Scripts/ui.core.js" type="text/javascript"></script>
<script src="/Scripts/ui.slider.js" type="text/javascript"></script>
<script type="text/javascript">
    var urlTagId = "<%=txtTagId.ClientID %>";
...
<script src="/AddonsByOsShop/CustomScripts/TajaxClient.js" type="text/javascript"></script>
...
<div style="display: none;">
    <asp:TextBox runat="server" ID="txtTagId"></asp:TextBox>
