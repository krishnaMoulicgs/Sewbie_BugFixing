    ...
    $iv.fn.extend({
        ...
        **/
        ...
        update_status: function()
        {
            if(!this.settings.ui_disabled)
            {
                ...
                if(percent)
                {
					$('.iviewer_zoom_status').html(percent + "%");//iviewer_zoom_status
        ...
        **/
        createui: function()
        {
            ...
            $(".iviewer_zoom_in").
            mousedown(function(){me.zoom_by(4); return false;});
            
            $(".iviewer_zoom_out").
            mousedown(function(){me.zoom_by(- 4); return false;});
            
            $(".iviewer_zoom_zero").
            mousedown(function(){me.set_zoom(100); return false;});
            
            $(".iviewer_zoom_fit").
            mousedown(function(){me.fit(this); return false;});
            
            this.zoom_object = $(".iviewer_zoom_status");
