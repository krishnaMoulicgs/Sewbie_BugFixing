...
var AjaxClient = {
    ...
    CreateUrl: function () {
        var strUrl = this.encode("CategoryId") + "=" + this.encode(this.$(urlCategoryId).value) + "&";
        strUrl += this.encode("urlSubcategoriesSelected") + "=" + this.encode(this.$("filterProductSubcategories").value) + "&";
    ...
    GetPageContent: function () {
        ...
        me.showCover();
        jQuery.ajax({
            url: "/AddonsByOsShop/AjaxPages/CgetProducts.aspx?" + location.hash.split("#")[1],
            type: "GET",
            dataType: "html",
...
$(function () {
    ...
    if (menu_maxPrice == menu_minPrice)
        menu_minPrice = 0;
