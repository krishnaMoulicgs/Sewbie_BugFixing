...
var AjaxClient = {
    ...
    CreateUrl: function () {
        var strUrl = this.encode("ManufacturerId") + "=" + this.encode(this.$(urlManufacturerId).value) + "&";
    ...
    GetPageContent: function () {
        ...
        me.showCover();
        jQuery.ajax({
            url: "/AddonsByOsShop/AjaxPages/MgetProducts.aspx?" + window.location.hash.split("#")[1],
            type: "GET",
            dataType: "html",
