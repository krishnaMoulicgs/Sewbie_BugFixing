...
namespace NopSolutions.NopCommerce.Common.Utils
{
    ...
    public partial class CommonHelper
    {
        ...
        /// <summary>
        /// Gets integer value from the Session 
        /// </summary>
        /// <param name="name">Parameter name</param>
        /// <returns>Query string value</returns>
        public static int SessionInt(string name)
        {
            string resultStr = HttpContext.Current.Session[name].ToString().ToUpperInvariant();
            int result;
            Int32.TryParse(resultStr, out result);
            return result;
        }
        ...
        public static bool IsVendor()
        {
            ...
            string adminUrl1 = GetStoreLocation(false) + "vendoradministration";
            string adminUrl2 = GetStoreLocation(true) + "vendoradministration";
            bool flag1 = thisPageUrl.ToLowerInvariant().StartsWith(adminUrl1.ToLower());
            bool flag2 = thisPageUrl.ToLowerInvariant().StartsWith(adminUrl2.ToLower());
            bool isVendor = flag1 || flag2;
            return isVendor;
        }
        ...
        /// </summary>
        /// <returns>Store admin location</returns>
        public static string GetVendorAdminLocation()
        {
            bool useSSL = IsCurrentConnectionSecured();
            return GetVendorAdminLocation(useSSL);
        }
        ...
        /// <summary>
        /// Gets vendor admin location
        /// </summary>
        /// <param name="useSsl">Use SSL</param>
        /// <returns>Store admin location</returns>
        public static string GetVendorAdminLocation(bool useSsl)
        {
            string result = GetStoreLocation(useSsl);
            result += "VendorAdministration/";
        ...
        /// <summary>
        /// Removes the special characters from a string.  Created for the Seller Route URL project.
        /// </summary>
        /// <returns>Result</returns>
