...
namespace NopSolutions.NopCommerce.BusinessLogic
{
    ...
    public partial class NopContext
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the context is running in VENDOR admin-mode
        /// </summary>
        public bool IsVendor
        {
            get
            {
                if (!_isVendor.HasValue)
                {
                    _isVendor = CommonHelper.IsVendor();
                }
                return _isVendor.Value;
            }
            set
            {
                _isVendor = value;
