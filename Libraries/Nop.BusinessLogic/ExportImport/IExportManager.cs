...
namespace NopSolutions.NopCommerce.BusinessLogic.ExportImport
{
    ...
    public interface IExportManager
    {
        ...
        /// <summary>
        /// Export orders to Charge
        /// </summary>
        /// <param name="filePath">File path to use</param>
        /// <param name="orders">Charge</param>
        void ExportChargeTypeToXls(string filePath, List<ChargeType> chargeTypes);
        /// <summary>
        /// Export Charge
        /// </summary>
        /// <param name="filePath">File path to use</param>
        /// <param name="orders">Charge</param>
        void ExportChargeToXls(string filePath, List<Charge> charges);
        /// <summary>
        /// Export Charge
        /// </summary>
        /// <param name="filePath">File path to use</param>
        /// <param name="orders">Charge</param>
        void ExportInvoiceToXls(string filePath, List<Invoice> invoices);
    }
}
