...
namespace NopSolutions.NopCommerce.BusinessLogic.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        /// <param name="ss">Order shippment status; null to load all orders</param>
        /// <returns>Order collection</returns>
        List<Order> SearchVendorOrders(DateTime? startTime, DateTime? endTime,
        ...
        /// <param name="orderBy">1 - order by total count, 2 - Order by total amount</param>
        /// <returns>Result</returns>
        List<BestSellersReportLine> VendorBestSellersReport(int lastDays, int recordsToReturn, int orderBy);
        ...
        /// <param name="endTime">End date</param>
        /// <returns>Result</returns>
        OrderAverageReportLine GetVendorOrderAverageReportLine(OrderStatusEnum os,
            DateTime? startTime, DateTime? endTime);
        ...
        /// <param name="os">Order status</param>
        /// <returns>Result</returns>
        OrderAverageReportLineSummary VendorOrderAverageReport(OrderStatusEnum os);
        ...
        /// <summary>
        /// Gets an order report for the vendor
        /// </summary>
        /// <param name="os">Order status; null to load all orders</param>
        /// <param name="ps">Order payment status; null to load all orders</param>
        /// <param name="ss">Order shippment status; null to load all orders</param>
        /// <returns>IdataReader</returns>
        OrderIncompleteReportLine GetVendorOrderReport(OrderStatusEnum? os,
            PaymentStatusEnum? ps, ShippingStatusEnum? ss);
        #endregion
        ...
        /// /// <param name="vendorId">Order Note</param>
        /// <param name="orderId">Order identifier</param>
        /// <returns>The error status, or String.Empty if no errors</returns>
        string PlaceOrder(PaymentInfo paymentInfo, Customer customer, int vendorId, string orderNote,
            out int orderId);
        ...
        /// <param name="orderId">Order identifier</param>
        /// <returns>The error status, or String.Empty if no errors</returns>
        Order TotalAmountForPayment(PaymentInfo paymentInfo, Customer customer);
        ...
        /// <returns></returns>
        Order TotalAmountForGuestPayment(PaymentInfo paymentInfo, Customer customer);
        ...
        /// <returns></returns>
        Order VendorBasedTotalAmountForGuestPayment(PaymentInfo paymentInfo, Customer customer, int vendorId);
        ...
        /// <param name="orderId">Order identifier</param>
        /// <returns>The error status, or String.Empty if no errors</returns>
        Order VendorBasedTotalAmountForPayment(PaymentInfo paymentInfo, Customer customer, int vendorId);
