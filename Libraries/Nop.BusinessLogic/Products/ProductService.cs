...
namespace NopSolutions.NopCommerce.BusinessLogic.Products
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        {
            return GetAllProducts(0, 0, 0, 0, null, null, null,
        ...
        public List<Product> GetAllProducts(int categoryId,
            int manufacturerId, int vendorId, int productTagId, bool? featuredProducts, 
            int pageSize, int pageIndex, out int totalRecords)
        {
            return GetAllProducts(categoryId, manufacturerId, vendorId, 
        ...
        {
            return GetAllProducts(categoryId, manufacturerId, 0,
                productTagId, featuredProducts, null, null,
            ...
            List<int> filteredSpecs, ProductSortingEnum orderBy, out int totalRecords)
        {
            ...
            return GetAllProducts(categoryId, manufacturerId, vendorId, productTagId,
            ...
            ProductSortingEnum orderBy, out int totalRecords)
        {
            return GetAllProducts(categoryId,
                manufacturerId, 0, productTagId, featuredProducts,
                priceMin, priceMax, 0,
                keywords, searchDescriptions, pageSize,
                pageIndex, filteredSpecs, languageId,
                orderBy, true, out totalRecords);
        }
        ...
        {
            return GetAllProducts(categoryId,
                manufacturerId, vendorId, productTagId, featuredProducts,
                priceMin, priceMax, 0,
                keywords, searchDescriptions, pageSize,
                pageIndex, filteredSpecs, languageId,
                orderBy, true, out totalRecords);
        ...
        /// <param name="orderBy">Order by</param>
        /// <param name="totalRecords">Total records</param>
        /// <param name="vendor ID">Vendor Identifier; 0 to load all records.</param>
        /// <returns>Product collection</returns>
        public List<Product> GetAllProducts(int categoryId,
            int manufacturerId, int vendorId, int productTagId, bool? featuredProducts,
            decimal? priceMin, decimal? priceMax,
            ...
            int pageIndex, List<int> filteredSpecs, int languageId,
            ProductSortingEnum orderBy, bool? isActivated, out int totalRecords)
        {
            if (pageSize <= 0)
                pageSize = 10;
            ...
            bool showHidden = NopContext.Current.IsAdmin || NopContext.Current.IsVendor;
            ...
            priceMax = priceMax + .01M;

            if (priceMin > .01M) { 
                priceMin = priceMin - .01M;
            }
            ...
            var products = _context.Sp_ProductLoadAllPaged(categoryId,
               ...
               languageId, (int)orderBy, true, totalRecordsParameter).ToList();
        ...
        public List<Product> GetRecentlyAddedProducts(int number)
        {
            ...
            //    0, 0, 0, null, null, null, 0, string.Empty, false, number,
            //    0, null, NopContext.Current.WorkingLanguage.LanguageId,
            //    ProductSortingEnum.CreatedOn, true, out totalRecords);
            //return products;
        }
        ...
        /// <returns></returns>
        public List<Product> GetFeaturedProductsForCategory(int categoryId)
        {
            var query = from p in _context.Products
        ...
        /// <returns></returns>
        public List<Product> GetFeaturedProductsForManufacturer(int manufacturerId)
        {
            var query = from p in _context.Products
                        join pm in _context.ProductManufacturers on p.ProductId equals pm.ProductId
        ...
        public bool CacheEnabled
        {
            get
            {
                return IoC.Resolve<ISettingManager>().GetSettingValueBoolean("Cache.ProductService.CacheEnabled");
            }
        }
