...
namespace NopSolutions.NopCommerce.BusinessLogic.Media
{
    ...
    public partial interface IPictureService
    {
        ...
        /// <summary>
        /// Get a picture URL in the wide aspect
        /// </summary>
        /// <param name="picture">Picture instance</param>
        /// <param name="targetSize">The target picture size (longest side)</param>
        /// <returns>Picture URL</returns>
        string GetWidePictureUrl(Picture picture, int targetSize);

        /// <summary>
        /// Get a picture URL in the long aspect
        /// </summary>
        /// <param name="picture">Picture instance</param>
        /// <param name="targetSize">The target picture size (longest side)</param>
        /// <returns>Picture URL</returns>
        string GetLongPictureUrl(Picture picture, int targetSize);
