...
namespace NopSolutions.NopCommerce.BusinessLogic.Infrastructure
{
    ...
    public class UnityPerExecutionContextLifetimeManager : LifetimeManager
    {
        ...
        /// <summary>
        /// Extension class from nopCommerce Forum post :
        /// <http://www.nopcommerce.com/boards/t/8378/unable-to-cast-object-of-type-nopcommercebusinesslogicdatanopobjectcontext-to-type-nopcommercebusinesslogicconfigurationsettingsisettingmana.aspx>
        /// inserted this class, to account for multiple keys in the container instead of
        /// constantly re-writing them.  The author of the solution claims this is why the first
        /// resolution call works, and the subsequent fail.  By adding a dictionary it is capable of
