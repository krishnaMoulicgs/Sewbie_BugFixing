...
namespace NopSolutions.NopCommerce.BusinessLogic.Infrastructure
{
    public class UnityDependencyResolver : IDependencyResolver
    {
        ...
        protected virtual void ConfigureContainer(IUnityContainer container)
        {
            ...
            container.RegisterType<IVendorService, VendorService>(new UnityPerExecutionContextLifetimeManager());
            container.RegisterType<IChargeTypeService, ChargeTypeService>(new UnityPerExecutionContextLifetimeManager());
            container.RegisterType<IChargeService, ChargeService>(new UnityPerExecutionContextLifetimeManager());
            container.RegisterType<IInvoiceService, InvoiceService>(new UnityPerExecutionContextLifetimeManager());
            container.RegisterType<IInvoiceChargesService, InvoiceChargesService>(new UnityPerExecutionContextLifetimeManager());
            //Object context
