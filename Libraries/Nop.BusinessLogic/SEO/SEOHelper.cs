...
namespace NopSolutions.NopCommerce.BusinessLogic.SEO
{
    ...
    public partial class SEOHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetSinglePageCheckOutShoppingCartUrl()
        {
            string url = string.Format("{0}SinglePageCheckOutShoppingCart.aspx", CommonHelper.GetStoreLocation());
            return url.ToLowerInvariant();
        }
        ...
        /// <summary>
        /// Gets login page URL of vendor admin area
        /// </summary>
        /// <returns>Login page URL</returns>
        public static string GetVendorAdminAreaLoginPageUrl()
        {
            string url = string.Format(CultureInfo.InvariantCulture, "{0}Login.aspx",
                      CommonHelper.GetVendorAdminLocation());
            return url.ToLowerInvariant();
        }
