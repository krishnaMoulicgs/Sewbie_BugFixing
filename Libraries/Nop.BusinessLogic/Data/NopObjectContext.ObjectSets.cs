...
namespace NopSolutions.NopCommerce.BusinessLogic.Data
{
    ...
    public partial class NopObjectContext : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<SellerCode> SellerCodes
        {
            get
            {
                if ((_SellerCodes == null))
                {
                    _SellerCodes = base.CreateObjectSet<SellerCode>("SellerCodes");
                }
                return _SellerCodes;
            }
        }
        private ObjectSet<SellerCode> _SellerCodes;
        ...
        public ObjectSet<Invoice_Charges> InvoiceCharges
        {
            get
            {
                if ((_InvoiceCharges == null))
                {
                    _InvoiceCharges = base.CreateObjectSet<Invoice_Charges>("Invoice_Charges");
                }
                return _InvoiceCharges;
            }
        }
        private ObjectSet<Invoice_Charges> _InvoiceCharges;
